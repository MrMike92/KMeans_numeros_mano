...
def main():
    try:
        data = np.loadtxt('optdigits.tes', delimiter=',')
    ...
    # Paso 4: Seleccionar los primeros dos componentes principales
    ...
    max_iterations_range = range(1, 21)
    ...
    # Elegir el valor óptimo de max_iterations
